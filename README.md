...
> [!IMPORTANT]
> Cloudflare CDN 已**禁止代理**方式使用，对于**代理套 Cloudflare CDN** 的自行承担风险，请勿过度依赖 [#382](https://github.com/XIU2/CloudflareSpeedTest/discussions/382) [#383](https://github.com/XIU2/CloudflareSpeedTest/discussions/383)
